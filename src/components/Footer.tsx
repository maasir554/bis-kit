...
export const Footer = () => {
    return (
        <footer className=" w-full py-8 gap-4 flex flex-row justify-center items-center bg-gradient-to-br from-themeblue/10  via-themeorange/10 to-themeblue/50 rounded-t-3xl flex-wrap">
