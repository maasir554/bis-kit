...
<main className="flex flex-col justify-center items-center w-full max-w-screen">
    <section id="Home" className="w-full min-h-screen flex flex-col px-4 justify-start items-center gap-5 bg-gradient-to-b from-black via-sky-950 to-themeblue pb-10">
        ...
        <div id="top-players" className=" flex flex-col items-center pb-20" >
            ...
            <p className="text-center w-full mb-10">
                collect the highest number of points and become the top scorer!
            </p>
